...
var TimeScale = class {
	...
	*/
	_private__updateConflationFactor() {
		...
		this._private__conflationFactor = Math.min(Math.pow(2, Math.floor(Math.log2(ratio))), 512);
	}
...
var PaneSeparator = class {
	...
	_private__addResizableHandle() {
		...
		this._private__mouseEventHandler = new MouseEventHandler(element, {
...
var ChartApi = class {
	constructor(container, horzScaleBehavior, options) {
		...
		this._private__timeScaleApi = new TimeScaleApi(this._private__chartWidget._internal_model(), this._private__chartWidget._internal_timeAxisWidget(), this._internal__horzScaleBehavior);
	}
	remove() {
